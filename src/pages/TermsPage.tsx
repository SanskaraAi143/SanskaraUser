      ...
      <main className="flex-grow container mx-auto px-4 py-12 pt-20 md:pt-24 lg:pt-28">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <div className=" p-8 rounded-2xl">
              <h2 className="text-2xl font-bold mb-4 ">Vendor Relationships</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className=" p-8 rounded-2xl">
              <h2 className="text-2xl font-bold mb-4 ">Contact Information</h2>              <p className="text-gray-700 leading-relaxed">
