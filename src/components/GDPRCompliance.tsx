...
const GDPRCompliance = () => {
  ...
  return (
    <>      {/* GDPR Banner */}
      <div className="fixed bottom-0 left-0 right-0 glass-card border-t-2 border-wedding-gold shadow-2xl z-50 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-start gap-4">
            <div className="p-2 bg-wedding-gold/20 rounded-full flex-shrink-0">
              <Cookie className="h-5 w-5 text-wedding-gold" />
            </div>
            <div className="flex-1">              <h3 className="font-bold text-yellow-800 mb-2 font-playfair">Your Privacy Matters to Us</h3>
