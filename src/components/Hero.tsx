          ...
          <div className="lg:w-1/2 animate-fade-in">
            ...
            <div className="mt-8 flex items-center gap-3">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map(i => <div key={i} className="h-10 w-10 rounded-full bg-wedding-red/20 border-2 border-white flex items-center justify-center text-xs font-semibold text-wedding-red">
